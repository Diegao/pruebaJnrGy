...
Route::get('/factorial', [\App\Http\Controllers\ClienteController::class, 'factorial'])->name('factorial');
Route::get('/amortizacion', [\App\Http\Controllers\ClienteController::class, 'amortizacion'])->name('amortizacion');

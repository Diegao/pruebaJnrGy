...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('servicios', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedInteger('usuario_id')->index('fk_soporte_servicios_user1_idx');
            ...
            $table->unsignedInteger('estado_servicios_id')->index('fk_servicios_estado_servicios1_idx');
            $table->text('problema');
            $table->text('solucion');
